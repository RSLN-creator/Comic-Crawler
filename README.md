...
**或者更换端口：
1. 编辑 `start.bat`，修改 `set "FRONTEND_PORT=3000` 为其他端口（如 `set "FRONTEND_PORT=3001`）
2. 编辑 `scripts/start.py`，修改 `FRONTEND_PORT = 3000` 为相同端口
3. 重新运行启动脚本
